...
//!   the target config file. The prior file is retained in an unpredictable,
//!   private sibling recovery directory before any mutation. Re-runs are
...
// will overwrite this file (with a private sibling recovery copy) on each
// re-run.
