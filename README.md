...
- Start the server with `--enable-web` and visit `/web` for a read-only
  ...
  **Full integration guide:** see [`docs/frontend-api.md`](docs/frontend-api.md)
  ...
  [`desktop-v0.3.0`](https://github.com/semantic-craft/engram/releases/tag/desktop-v0.3.0)
...
[`docs/usage.md`](docs/usage.md#stage-and-apply-project-instruction-proposals) for the
